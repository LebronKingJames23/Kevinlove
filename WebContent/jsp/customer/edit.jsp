...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/customer/editCustomer.action"
		method=post>
							...
							<TR>
								...
								<select name="custlevel" >
									<c:forEach var="dict" items="${list}">
										<option value="${dict.lid}" <c:if test="${dict.lid==customer.custlevel}">selected</c:if>>${dict.lname}</option>
									</c:forEach>
