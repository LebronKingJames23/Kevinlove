...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkman/editLinkman.action"
		method=post>
								...
								<td colspan="3">
									<select name="customer.cid">
										<c:forEach items="${list}" var="customer">
											<option value="${customer.cid}"<c:if test="${linkman.customer.cid==customer.cid}">selected</c:if>>${customer.custName}</option>
										</c:forEach>
									</select>
								</td>
							</tr>
