...
<HEAD id=Head1>
<TITLE>导航</TITLE><script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.4.4.min.js"></script>
...
<SCRIPT language=javascript>
	function test() {
		...
		$.ajax({
				type:"post",
                url:"${pageContext.request.contextPath}/text/recparams.action",
				data:JSON.stringify(data1),
				contentType:"application/json;charset=utf-8",
				success:function(data){
                    alert(data.dict.lname);
				}
            }
		)
    }
								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
<TR>
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer/toadd.action"
		target=main>－ 新增客户</A></TD>
</TR>
<TR> 
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer/tolist.action"
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/linkman/toaddLinkman.action"
								...
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/visit/toadd.action"
														target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/visit/visitlist.action"
									...
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/linkman/select.action"
														target=main>－ 联系人信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/visit/select.action"
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer/level.action"
														target=main>－客户等级统计</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer/source.action"
														target=main>－客户来源统计</A></TD>
												</TR>
													<TR>
												<td> <input type="button" onclick="test()" value="接口问题"/></td>
											<TR>
											</TBODY>
										</TABLE>
									</TD>
