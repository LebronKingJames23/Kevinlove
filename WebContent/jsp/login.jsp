...
<HEAD>
 <script type="text/javascript" src="${pageContext.request.contextPath }/js/jquery-1.4.4.min.js"></script>
  <script type="text/javascript">
     function checkCode(){
        $("#code").attr("src", "${pageContext.request.contextPath}/code/acode.action?timestamp=" + (new Date()).valueOf());
    };
</script>
...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/User/login.action" method=post target="_parent">
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TR><TD style="HEIGHT: 28px">验证码：<input type="text" style="WIDTH: 130px"  ><img id="code" src="${pageContext.request.contextPath}/code/acode.action" onclick="checkCode()"></TD></TR>
